 ...
 *
 * hdskins:textures/com.minelittlepony.hdskins.skins/com.minelittlepony.hdskins.skins.json
 * {
 *      "com.minelittlepony.hdskins.skins": [
 *          { "type": "SKIN", "model": "default", "name": "Sollace", "skin": "hdskins:textures/com.minelittlepony.hdskins.skins/super_silly_pony.png" }
 *      ]
 * }
 *
 */
public class SkinResourceManager implements IdentifiableResourceReloadListener {
    ...
    private static final Identifier ID = new Identifier("hdskins", "com.minelittlepony.hdskins.skins");
    ...
    static class SkinData {
        ...
        static class Skin {
            ...
            private Identifier createTexture() {
                ...
                return new Identifier("hdskins", String.format("textures/com.minelittlepony.hdskins.skins/%s.png", skin));
            }
